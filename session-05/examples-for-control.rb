...
comment do
  ...
  notes = (scale :c5, :minor_pentatonic, num_octaves: 1).shuffle
    s = synth :fm, note: notes.tick, release: 0.25, depth: 0.25, divisor: 0.5, cutoff: 130
    control s, cutoff: 80 #, cutoff_slide: 0.125, depth: 1, depth_slide: 0.075, divisor: 1, divisor_slide: 0.075
    sleep 0.25
  end
end
